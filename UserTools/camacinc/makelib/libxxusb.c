 ...
 * Created : Summer 2012
 *
 * Based on the original libxxusb.cpp.
...
usb_dev_handle*   xxusb_device_open(struct usb_device *dev)
{
    ...
    int count =0;
    int namelen=60;
    char usb_driver_name[namelen];
    usb_dev_handle *udev;
    udev = usb_open(dev);
    usb_get_driver_np(udev,0,usb_driver_name,namelen);
/*
 *     usb_driver_name[namelen-1] = '0';
...
{
  /* 13-Jun-2012 Geoff Savage */
  /* libxxusb.cpp:617: warning: unused variable ‘DevFound’ */
  /* short DevFound = 0; */
